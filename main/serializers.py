...
class ProblemaSerializer(serializers.ModelSerializer):
    author = serializers.ReadOnlyField(source='author.username')   #ReadOnlyField-значит необязательно к заполнению  #author.username - можно указать номер
